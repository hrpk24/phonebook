<?php
/* Smarty version 4.1.1, created on 2022-07-24 11:40:48
  from '/Applications/XAMPP/xamppfiles/htdocs/tellhone/views/body/register/after.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_62dd13a0b50401_71902629',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e725c3f11e76f2ea043fda808c6e29462e89e336' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/tellhone/views/body/register/after.tpl',
      1 => 1658655606,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:../../header/registerheader.tpl' => 1,
  ),
),false)) {
function content_62dd13a0b50401_71902629 (Smarty_Internal_Template $_smarty_tpl) {
?>    <html>

    <?php $_smarty_tpl->_subTemplateRender('file:../../header/registerheader.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

    <body>
        <div class="forny-container" dir="ltr">
            <div class="alert alert-success">
                <strong> Registration was successful.</strong> <a href="login.php" class="alert-link">Login here </a>
            </div>
            <div class="forny-inner">
                ...
                <div class="forny-form">
                    <div class="text-center">
                        ...
                        <p class="mb-10">Create a new account in minutes.</p>
                    </div>
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input required class="form-control" name="user" type="username" placeholder="Username">
        ...
        <?php echo '<script'; ?>
 src="user/js/jquery.min.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="user/js/bootstrap.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="user/js/main.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="user/js/demo.js"><?php echo '</script'; ?>
>
    </body>
